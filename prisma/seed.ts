...
async function seedFrontendRoadmapTemplates(): Promise<void> {
  ...
  console.log(
    `Seeded full-stack roadmap template with ${PREP_SESSIONS.length} interview sessions, ${plan.chapters.length} DSA chapters, and ${plan.totalQuestions} DSA question mappings.`
  );
}
