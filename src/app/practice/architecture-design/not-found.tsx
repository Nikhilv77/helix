...
export default function ArchitectureDesignNotFound() {
  return (
    <div className="mx-auto flex min-h-[72svh] w-full max-w-[86rem] items-center bg-black px-5 py-16 sm:px-8">
      <section className="w-full max-w-xl">
        ...
        <h1 className="mt-6 font-display text-[clamp(2rem,5vw,3.2rem)] font-semibold leading-[1.04] tracking-[-0.04em] text-cream">
          This scenario isn&apos;t in your path.
        </h1>
        <p className="mt-4 max-w-lg text-[15px] leading-7 text-cream/58">
          The link may be out of date. Other candidates&apos; Architecture history is never visible
          here.
        </p>
        <Link
