...
export default function AppliedEngineeringError({ reset }: { reset: () => void }) {
  return (
    <main className="mx-auto flex min-h-[72svh] w-full max-w-[86rem] items-center px-5 py-16 sm:px-8">
      <section role="alert" className="max-w-xl">
        ...
        <div className="mt-7 flex flex-wrap gap-3">
          ...
          <Link href="/practice" className="inline-flex min-h-11 items-center rounded-xl border border-white/[0.08] px-5 text-[14px] font-semibold text-cream/68 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--workspace-accent)]">
            Back to Practice
          </Link>
        </div>
      </section>
