...
/** Browser-safe mirror of the persisted roadmap status values. */
export type ProgressRoadmapStatus = "LOCKED" | "ACTIVE" | "IN_PROGRESS" | "COMPLETED" | "SKIPPED";
