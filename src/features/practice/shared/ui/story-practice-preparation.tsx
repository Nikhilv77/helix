...
export type StoryPracticePreparationProps = {
...
export function StoryPracticePreparation({ experience }: StoryPracticePreparationProps) {
  ...
  if (!selected) {
    throw new Error(`At least one ${experience.subjectNoun} preparation option is required.`);
  }
