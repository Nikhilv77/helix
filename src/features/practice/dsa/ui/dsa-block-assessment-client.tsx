  ...
  return (
    <div className="grid min-h-[calc(100vh-8.5rem)] gap-3 xl:grid-cols-[minmax(20rem,0.72fr)_minmax(30rem,1.28fr)]">
      ...
      <section className="flex min-h-[46rem] flex-col overflow-hidden rounded-2xl border border-white/[0.065] bg-[#101214]">
        <div className="flex min-h-14 items-center justify-between gap-3 border-b border-white/[0.06] px-4">
          ...
          <div className="flex items-center gap-2">
            <select
              value={language}
              onChange={(event) => onLanguageChange(event.target.value as DsaEditorLanguage)}
              className="h-9 rounded-lg border border-white/[0.07] bg-white/[0.04] px-3 text-xs text-cream/72 outline-none"
            >
              {LANGUAGES.map((item) => (
            ...
            <button
              ...
              className="inline-flex h-9 items-center gap-2 rounded-lg bg-cream px-4 text-xs font-semibold text-[#090a0b] disabled:opacity-35"
            >
