import phase1Arrays from "@/features/practice/dsa/content/phase-1-arrays.json";
import phase2Strings from "@/features/practice/dsa/content/phase-2-strings.json";
import phase3SlidingWindow from "@/features/practice/dsa/content/phase-3-sliding-window.json";
import phase4BinarySearch from "@/features/practice/dsa/content/phase-4-binary-search.json";
import phase5LinkedList from "@/features/practice/dsa/content/phase-5-linked-list.json";
import phase6StackQueue from "@/features/practice/dsa/content/phase-6-stack-queue.json";
import phase7Trees from "@/features/practice/dsa/content/phase-7-trees.json";
import phase8Heap from "@/features/practice/dsa/content/phase-8-heap.json";
import phase9Graphs from "@/features/practice/dsa/content/phase-9-graphs.json";
import phase10DynamicProgramming from "@/features/practice/dsa/content/phase-10-dynamic-programming.json";
import phase11TriesBacktracking from "@/features/practice/dsa/content/phase-11-tries-backtracking.json";
