        ...
        <header className="relative overflow-hidden rounded-[1.75rem] border border-white/[0.08] bg-[#151619]">
          <div className="relative px-5 py-6 sm:px-7 sm:py-7 lg:px-8">
            <div className="flex flex-col items-center text-center">
              <span className="relative grid h-28 w-28 shrink-0 place-items-center overflow-hidden rounded-full border border-white/[0.12] bg-black p-0.5 sm:h-32 sm:w-32">
