...
function SkeletonCard() {
  return (
    <div className="rounded-[1.2rem] border border-white/[0.14] bg-black p-5">
      <div className="flex items-center gap-3">
        <span className="h-12 w-12 shrink-0 rounded-full border border-white/[0.14] bg-black" />
        <div className="flex-1 space-y-2">
          <SkeletonLine className="h-2.5 w-32" />
          <SkeletonLine className="h-2 w-52 max-w-full" />
        </div>
      </div>
      <div className="mt-5 rounded-xl border border-white/[0.1] bg-black p-3.5">
    ...
    >
      <div className="mx-auto w-full max-w-[88rem] animate-pulse px-4 pb-24 pt-8 sm:px-8 sm:pt-10 lg:px-10">
        <header className="flex flex-col items-center border-b border-white/[0.12] pb-10 sm:pb-12">
          <span className="h-24 w-24 rounded-full border border-white/[0.15] bg-black sm:h-28 sm:w-28" />
          <SkeletonLine className="mt-4 h-3 w-28" />
          <SkeletonLine className="mt-3 h-2 w-20" />
          <span className="mt-4 h-8 w-28 rounded-full border border-white/[0.14] bg-black" />
        </header>
